...
\begin{proof}
   ...
   \begin{itemize}
      \item {
         ...
         我们将根据$A_0'$的$\varphi\mathcal{E}_{i_1}$树构建$A_1$关于$\varphi\mathcal{E}$的条件等价森林。
         ...
         我们根据$A_0'$构建每一个$B'$关于$\varphi_i\mathcal{E}$的等价森林。
         此时将$B$所在的$\varphi_i\mathcal{E}$等价树$t_{A_1}^{i}$复制并
         与每个$B'$的$\varphi_i\mathcal{E}$的等价森林中的等价树相连，
         我们可以得到$A_1$关于$\varphi_i\mathcal{E}$的条件等价森林。
      }
      \item {
         ...
         我们根据$A_0^1$构建每个$N'$关于$\varphi_i\mathcal{E}$的条件等价森林。
      }
      \item {
