...
\begin{itemize}
   ...
   \item {
      ...
      则存在$\varphi$的划分$\{\varphi_i\}_{i\in I}$，和集合$\{B\rightsquigarrow_{\psi_i\mathcal{E}}\stackrel{q_i}{\rightarrow}_{\psi_i'} \mathcal{C}\}$，
      使得$i\in I$，$\mathsf{Th}\vdash \varphi_i\Rightarrow \psi_i\psi_i'$且$\sum_{i\in I}q_i\geq q$。
   }
\end{itemize}
\end{definition}
      ...
      \item {
         ...
         \begin{itemize}
            \item {
               ...
               可以模拟上述操作，
               其中$\mathsf{Th}\vdash(x=1)\wedge(y\leq 1)\Rightarrow (x=t)\wedge(y\leq 1)\wedge(y<5)$
            ...
            \item {
               ...
               存在集合$\{\overline{a}(x).G(x)\rightsquigarrow_{(x=t)\mathcal{S}}\stackrel{\overline{a}(t')}{\longrightarrow}_{(x=t)}G(t')\}$
               可以模拟上述操作，其中$\mathsf{Th}\vdash ((x=t)\wedge (y>1))\Rightarrow (x=t) \wedge ((x=t)\wedge (y>1))\Rightarrow t=t'$，$(G(t),G''(t,y))\in\mathcal{S}$。
               ...
               存在集合$\{\overline{a}(x).G(x)\rightsquigarrow_{(x=t)\mathcal{S}}\stackrel{\overline{a}(t')}{\longrightarrow}_{(x=t)}G(t')\}$
               可以模拟上述操作，其中$\mathsf{Th}\vdash ((x=t)\wedge (y<5))\Rightarrow (x=t) \wedge ((x=t)\wedge (y<5))\Rightarrow t=t'$，$(G(t),G''(t,y))\in\mathcal{S}$。
            }
         \end{itemize}
      }
      \item {
