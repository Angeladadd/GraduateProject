...
\begin{corollary}
   ...
   \begin{itemize}
      \item {
         若$B\stackrel{q}{\rightarrow}_{\varphi}B',q\in (0,1)$，则存在$B\stackrel{\coprod_{i\in [k]}}{\longrightarrow}_{\varphi} \coprod_{i\in [k]} B_i$，
         且$B$有且仅有$B_1,\dots, B_k$这$k$个儿子节点。
      }
      \item {
         若存在$B\stackrel{1}{\rightarrow}_{\varphi}B'$，则$B\stackrel{\tau}{\rightarrow}_{\varphi}B'$且$B$有且仅有$B'$一个儿子节点。
      }
   \end{itemize}
\end{corollary}
