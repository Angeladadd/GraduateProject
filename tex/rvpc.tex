...
\begin{itemize}
   ...
   \item {
      ...
      则存在$\varphi$的划分$\{\varphi_i\}_{i\in I}$，和集合$\{B\rightsquigarrow_{\varphi_i\mathcal{E}}\stackrel{q_i}{\rightarrow}_{\psi_i} \mathcal{C}\}$，
      使得$i\in I$，$\mathsf{Th}\vdash \varphi_i\Rightarrow \psi_i$且$\sum_{i\in I}q_i\geq q$。
   }
\end{itemize}
\end{definition}
...
\begin{proof}
   ...
   \begin{itemize}
      \item {
         ...
         \begin{itemize}
            \item {
               ...
               可以模拟上述操作，
               其中$\mathsf{Th}\vdash(x=1)\wedge(y\leq 1)\Rightarrow \wedge(y<5)$
               且$\mathsf{Th}\vdash (x=t)\wedge (y\leq 1)\Rightarrow (t=t')$，
               $(G(t),G''(t,y))\in\mathcal{S}$。$(x=t)\wedge(y>1)$相同。
            }
            \item {
               对$x$的每一个赋值$t\in V$，
               ...
               可以模拟上述操作，其中$\mathsf{Th}\vdash ((x=t)\wedge (y>1))\Rightarrow (x=t) \wedge \mathsf{Th}\vdash ((x=t)\wedge (y>1))\Rightarrow t=t'$，$(G(t),G''(t,y))\in\mathcal{S}$。
               ...
               可以模拟上述操作，其中$\mathsf{Th}\vdash ((x=t)\wedge (y<5))\Rightarrow (x=t) \wedge\mathsf{Th}\vdash ((x=t)\wedge (y<5))\Rightarrow t=t'$，$(G(t),G''(t,y))\in\mathcal{S}$。
            }
         \end{itemize}
      }
      \item {
      ...
      \item {
         ...
         其中$\mathsf{Th}\vdash (\top\Rightarrow\top)$且$\frac{1}{2}\geq \frac{1}{2}$，$(\overline{a}(x).G(x),(y>1)\overline{a}(x).G''(x,y)|(y<5)\overline{a}(x).G''(x,y))\in\mathcal{S}$。
...
\begin{proof}
   ...
   \begin{itemize}
      \item {
         ...
         和集合$S=\{B\rightsquigarrow_{\varphi_i\mathcal{E}}\stackrel{\lambda}{\rightarrow}_{\psi_i}\mathcal{C}|\mathsf{Th}\vdash \varphi_i\Rightarrow\psi_i\}_{i\in I}$。
         对于$B$关于$\varphi_i\mathcal{E}$的条件等价树$t^B_{\varphi_i\mathcal{E}}$上的节点$L$，
         因为$\mathsf{Th}\vdash\varphi_i\Rightarrow \psi_i$，
         若$L\stackrel{\lambda}{\rightarrow}_{\psi_i}L'\in \mathcal{C}$，
         则$L\stackrel{\lambda}{\rightarrow}_{\varphi_i}L'\in \mathcal{C}$，
         因此存在集合$S'=\{B\rightsquigarrow_{\varphi_i\mathcal{E}}\stackrel{\lambda}{\rightarrow}_{\varphi_i}\mathcal{C}\}_{i\in I}$，
         根据定义~\ref{def:rvpc_symbolic_bisimulation}，
         ...
         由于$B\mathcal{E}C$，对于每一个$B\rightsquigarrow_{\varphi_i\mathcal{E}}\stackrel{\lambda}{\rightarrow}_{\varphi_i}\mathcal{C}$，
         根据定义存在$\varphi_i$的划分$\{\varphi_{i,j}\}_{j\in J}$
         和集合$S_i=\{C\rightsquigarrow_{\varphi_{i,j}\mathcal{E}}\stackrel{\lambda}{\rightarrow}_{\psi_{i,j}}\mathcal{C}|\mathsf{Th}\vdash \varphi_{i,j}\Rightarrow \psi_{i,j}\}_{j\in J}$，
      ...
      \item {
         ...
         由于$A\mathcal{E}B$，存在$\varphi$的划分$\{\varphi_i\}_{i\in I}$和集合$\{B\rightsquigarrow_{\psi_i\mathcal{E}}\stackrel{q_i}{\rightarrow}_{\psi_i'} \mathcal{C}|\mathsf{Th}\vdash \varphi_i\Rightarrow \psi_i\psi_i'\}$，
         其中$\sum_{i\in I} q_i\geq q$。
...
\end{theorem}
\begin{proof}
   $=_{\mathbb{RVPC}_{\mathsf{Th}}}$对于随机选择和非确定性选择的封闭性比较容易证明。
